    ...
    <div className="space-y-3">
      ...
      <AnimatePresence>
        {appliedDiscount && (
          ...
          >
            <div className="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900 rounded-md p-3 flex items-center justify-between">
          ...
          <CollapsibleContent>
            <div className="p-3 pt-0 space-y-2">
              ...
              <div className="pt-1 pb-1">
                <p className="text-xs text-muted-foreground">Try these demo codes: JACKIE_10, JACKIE_FREESHIP, OGGYTEAM</p>
              </div>
            </div>
          </CollapsibleContent>
        </Collapsible>
