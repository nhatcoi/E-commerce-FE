...
// Actions
import { fetchProductById, clearCurrentProduct } from "src/store/slices/product/productsSlice";
                ...
                <div className="space-y-3 text-sm">
                  {product.specifications && product.specifications.length > 0 ? (
                    product.specifications.map((spec, index) => (
                      <div key={index} className="grid grid-cols-2 gap-2 pb-2 border-b border-border/40 last:border-0">
